---
name: esp32-safety
description: Use when adding or reviewing ESP32 safety stops, AUTO preconditions, UWB stale/lost handling, out-of-bounds checks, Pi timeout behavior, or safety messages to the app.
---
...
- Target is inside robot working area.

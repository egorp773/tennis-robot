---
name: flutter-app
description: Use when working on the Flutter app UI, Riverpod state, WebSocket client, court map, robot pose calibration, zone selection, joystick, telemetry, or developer terminal.
---
...
Before product/demo polish, split or isolate:
